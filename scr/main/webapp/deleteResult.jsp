...
function Function3() {
  ...
  <body onload="startTime()">
	...
	<br><br><br>
	   <div class="login-box">
        <div class="heading">Delete result section</div>
        <form name="formal" method="post" action="deleteResult" autocomplete="off">
        ...
        <button name="submit" id="login-btn">DELETE RESULT</button>
        </form>
