...
function Function3() {
  ...
  <body onload="startTime()">
	...
	<br><br><br>
   <div class="login-box">
        <div class="heading">Upload Examiner Arrangements</div>
        <form name="formal" method="post" action="uploadEX" autocomplete="off" enctype="multipart/form-data">
     ...
     <div class="form-input">
        ...
        <div class="form-input">
        	...
        	<input type="file"  id = "examiner" name="examiner" required/>
        </div>
        ...
        <a href = "viewExaminer.jsp"><button name="submit" id="sbt-btn" value = "Send File">VIEW EXAMINER LIST</button></a>
