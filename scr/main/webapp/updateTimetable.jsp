...
function Function3() {
  ...
  <body onload="startTime() ; visibility();">
    ...
    <br><br><br>
   <div class="login-box">
        <div class="heading">Update Timetable</div>
        <form name="formal" method="post" action="updatett" autocomplete="off" enctype="multipart/form-data">
     ...
     <div class="form-input">
        ...
        if (timetable != null) {
            ...
            System.out.println(timetable.getSize());
            System.out.println(timetable.getContentType());
        ...
        -->
        <div class="form-input">
        	<label for="file" class="file">Change File : </label>
        	<input type="file"  id = "timetable" name="timetable"  value = "send file">
  
       </div>
		<iframe src="timetable/<%=filename%>" width="100%" height="200px">
   		</iframe>
