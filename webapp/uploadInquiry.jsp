...
function Function3() {
  ...
  <body onload="startTime()">
	...
	<br><br><br>
   <div class="login-box">
        <div class="heading">Inquiries</div>
        <form name="formal" method="post" action="insertIn" autocomplete="off" enctype="multipart/form-data">
            ...
            <div>
                <input type="text" id="number" name="number" placeholder="Enter your Registration Number"/>
            </div>
        </div>
     ...
     <div class="form-input">
		 ...
		 <div class="form-input">
            <label for="Select">Request/Inquiry type</label><br>

            <select name="inquirytype" class="year">
                <option hidden disable>Select One</option>
                <option value="reg">Registrations</option>
                <option value="exm">Examinations</option>
         ...
         <div class="form-input">
        	...
        	<input type="file"  id = "inquiry" name="inquiry" />
        </div>


        
        <button name="submit" id="sbt-btn" value = "Send File">Submit</button>
        <button name="submit" id="sbt-btn" value = "Send File">Reset</button>
