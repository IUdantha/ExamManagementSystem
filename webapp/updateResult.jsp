...
function Function3() {
  ...
  <body onload="startTime()">
	...
	<br><br><br>
	   <div class="login-box">
        <div class="heading">Update result section</div>
        <form name="formal" method="post" action="updateResult" autocomplete="off">
        
        <div class="form-input">
            	<label for="Name">Enter Result ID</label>
           		<div>
                	<input type="number" min = 1 id="rid" name="rid" placeholder="Result ID" required/>
            	</div>
        </div>
        
        
        <br><br><br>
        <div class="heading">Enter Updated details</div>
        <div class="form-input">
           		<div>
                	<input type="text" id="sid" name="sid" placeholder="Enter SID (EX :ITXXXXXXXX)" required/>
            	</div>
        </div>
        
     	<div class="form-input">
       		 <div>
             	<input type="text" id="qType" name="qType" placeholder="Enter Quiz (Ex :Computing_Y1_IT1040)" required/>
         	</div>
        </div>
        
        <div class="form-input">
       		 <div>
                <input type="number" min = 1 max = 60 id="marks" name="marks" placeholder="Enter Marks" required/>
            </div>
        </div>
           
        <button name="submit" id="login-btn">UPDATE RESULT</button>
        </form>
