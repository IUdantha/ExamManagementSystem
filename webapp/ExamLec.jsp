...
function Function3() {
	...
	function FunctionExaminer() {
		 var user = '${userType}';
		 
		
		 if(user == "lec"){
			 window.open("viewExaminer.jsp","_self");
		 }
		 
		 else if(user == "examDep"){
			 window.open("uploadExaminer.jsp","_self");
		 }
  ...
  <body onload="startTime()">
   ...
   <div class="op-background">
		<div class="op-btn">
        	...
        	<div class="design-btn"><a href="createQuiz.jsp" ><button id="register-btn" >Create Quiz<br><br><ion-icon name="book-outline" class="timetable"></ion-icon></button></a></div>
        	<div  class="design-btn"><a href="viewQuestion.jsp" ><button id="seat-btn">View Question<br><br><ion-icon name="eye-outline" class="timetable"></ion-icon></button></a></div>
        	<div  class="design-btn"><a href="updateQuestion.jsp" ><button id="seat-btn">Update Question<br><br><ion-icon name="reader-outline" class="seat"></ion-icon></button></a></div>
        	<div  class="design-btn"><a href="deleteQuiz.jsp" ><button id="seat-btn">Delete Question<br><br><ion-icon name="close-circle-outline" class="result"></ion-icon></button></a></div>
        	<div  class="design-btn"><a href="javascript:FunctionExaminer()" ><button id="seat-btn">View Examiners List<br><br><ion-icon name="list-circle-outline" class="seat"></ion-icon></button></a></div>
       </div> 
    </div>
