  ...
  <body onload="startTime()">
	...
	<div class="op-background">
		<div class="op-btn">
        	...
        	<div  class="design-btn"><a href="javascript:FunctionExaminer()" ><button id="examiner-btn">Assign Examiners<br><br><ion-icon name="reader-outline" class="seat"></ion-icon></button></a></div>
        </div> 
    </div>
