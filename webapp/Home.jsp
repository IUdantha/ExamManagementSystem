...
<html>
 ...
 <head>
	...
	function FunctionTime() {
			 ...
			 if(user == "std"){
				 window.open("viewTimetable.jsp","_self");
			 }
				 ...
				 window.open("uploadTimetable.jsp","_self");
			 }
			 
	}
		
		
	function FunctionSeat() {
			 var user = '${userType}';
			 
			 if(user == "std"){
				 window.open("viewSeat.jsp","_self");
			 }
				 ...
				 window.open("uploadSeat.jsp","_self");
			 }
  ...
  <body onload="startTime()">
    ...
    <div class="op-background">
		...
		<div class="op-btn">
	        ...
	        <div class="design-btn"><a href="javascript:FunctionTime();" ><button id="timetable-btn" >Time Table<br><br><ion-icon name="calendar-outline" class="timetable"></ion-icon></button></a></div>
	        <div  class="design-btn"><a href="javascript:FunctionSeat();"><button id="seat-btn">Seat Arrangements<br><br><ion-icon name="reader-outline" class="seat"></ion-icon></button></a></div>
	        <div  class="design-btn"><form action="viewResult" method="post"><button id="results-btn">Results<br><br><ion-icon name="trophy-outline" class="result"></ion-icon></button></a></div>
