...
function Function3() {
  ...
  <body onload="startTime()">
	...
	<br><br><br>
	   <div class="login-box">
        <div class="heading">Select the exam</div>
        <form name="formal" method="post" action="updateQuestion" autocomplete="off">
       ...
       <div class="form-input">
        ...
        <div class="form-input">
            	<label for="Name">Enter Question Number</label>
           		<div>
                	<input type="number" min = 1 max = 60 id="newQno" name="newQno" placeholder="Between 1 to 60" required/>
            	</div>
        </div>
        
        
        <br><br><br>
        <div class="heading">Enter new Question</div>
        <div class="form-input">
           		<div>
        ...
        <button name="submit" id="login-btn">UPDATE QUESTION</button>
        </form>
