...
function Function3() {
  ...
  <body onload="startTime()">
	...
	<br><br><br>
	   <div class="login-box">
        <div class="heading">Enter Quiz Details</div>
        <form name="formal" method="post" action="createQuiz" autocomplete="off">

        <div class="form-input">
            <label for="Select">Faculty</label><br>

            <select name="faculty" class="userType" required>
                <option value="" hidden disable>Select One</option>
       ...
       <div class="form-input">
            ...
            <select name="year" class="userType" required>
                <option value="" hidden disable>Select One</option>
            	...
            	<label for="Name">Module Code</label>
           		<div>
                	<input type="text" id="mcode" name="mcode" placeholder="Enter Module Code" required/>
            	</div>
        </div>
      	...
      	<div class="form-input">
            	<label for="Name">Number of Questions</label>
           		<div>
                	<input type="number" min="1" max="60" id="noQ" name="noQ" placeholder="Between 1 to 60" required/>
            	</div>
        </div>
        
		<div class="form-input">
            	<label for="Name">Enroll Key</label>
           		<div>
                	<input type="text" id="enrollkey" name="enrollkey" placeholder="Enter Enrollment key" required/>
            	</div>
        </div>
        
     	<div class="form-input">
         	<label for="Name">Quiz Password</label>
       		 <div>
             	<input type="text" id="quizPass" name="quizPass" placeholder="Enter Quiz password" required/>
         	</div>
        </div>
           
        <button name="submit" id="login-btn">CREATE QUIZ</button>
        </form>
