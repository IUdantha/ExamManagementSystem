...
function Function3() {
  ...
  <body onload="startTime()">
    <header>
      <div class="upnav">
        ...
        <div class="searchLogin">
          ...
          <div class="lgn"><a href="Profile.jsp">
	...
	<br><br><br>
	   <div class="login-box">
        <div class="heading">Select the exam to DELETE</div>
        <form name="formal" method="post" action="deleteQuiz" autocomplete="off">
       ...
       <div class="form-input">
        ...
        <button name="submit" id="login-btn">DELETE QUIZ</button>
        </form>
